...
class TransactionDetails : AppCompatActivity() {
    ...
    private fun setValuesToViews(){
        ...
        if (type == 1) {
            ...
            tvAmountDetails.setTextColor(Color.parseColor("#FFBB86FC"))
    ...
    private fun openUpdateDialog(
        ...
        btnUpdateData.setOnClickListener {
            ...
            @Suppress("NAME_SHADOWING") val date: Long = dateUpdate
            @Suppress("NAME_SHADOWING") val simpleDateFormat = SimpleDateFormat("dd/MM/yyyy", Locale.ENGLISH)
            val result = Date(date)
            tvDateDetails.text = simpleDateFormat.format(result)
