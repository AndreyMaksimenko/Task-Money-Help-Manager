...
class TransactionFragment : Fragment(){
    ...
    private fun visibilityOptions (){
        ...
        val typeSpinnerAdapter = ArrayAdapter(this.requireActivity(),
            R.layout.selected_spinner,typeList)
        ...
        val timeSpanAdapter = ArrayAdapter(this.requireActivity(),
            R.layout.selected_spinner, timeSpanList)
